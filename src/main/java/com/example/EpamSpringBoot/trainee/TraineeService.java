...
public class TraineeService {
    ...
    public TraineeService(TraineeRepository traineeRepository, UserService userService, TrainingRepository trainingRepository, TraineeErrorValidator traineeErrorValidator) {
    ...
    public Trainee readById(Long id) {
        return traineeRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("trainer is not found with this id : " + id));
    }
    ...
    public Trainee update(Trainee updateRequest) {
        if (traineeErrorValidator.isValidParamsForUpdate(updateRequest)) {
            Trainee trainee = traineeRepository.findById(updateRequest.getId()).orElseThrow(() -> new EntityNotFoundException("trainer is not found with this id : " + updateRequest.getId()));
    ...
    public Trainee passwordChangeTrainee(String password, Long id) {
        Trainee trainee = traineeRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("trainer is not found with this id : " + id));
